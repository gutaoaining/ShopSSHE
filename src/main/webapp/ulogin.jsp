...
<script src="loginfiles/cdntest.js" type="text/javascript"></script>
<!--[if lt IE 9]>
...
<![endif]-->
<link href="loginfiles/a.css" rel="stylesheet" type="text/css"><script src="loginfiles/a.js"></script><link href="loginfiles/default_f7b28aa3.css" type="text/css" rel="stylesheet">
...
.lt-plugins-simplevaliderrortips em{bottom:-21px;z-index:998;border-top-color:#ffd999;}</style></head>
<body id="user-regh"><div class="" style="display: none; position: absolute;">
<div class="aui_outer">
<table class="aui_border">
<tbody>
<tr><td class="aui_nw"></td>
<td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td>
<td class="aui_c"><div class="aui_inner"><table class="aui_dialog">
<tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div style="cursor: move;" class="aui_title"></div><a class="aui_close" href="javascript:;">×</a></div></td></tr>
<tr><td style="display: none;" class="aui_icon"><div style="background: transparent none repeat scroll 0% 0%;" class="aui_iconBg"></div></td><td style="width: auto; height: auto;" class="aui_main"><div style="padding: 20px 25px;" class="aui_content"></div></td></tr>
<tr><td colspan="2" class="aui_footer"><div style="display: none;" class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td style="cursor: se-resize;" class="aui_se"></td></tr></tbody></table></div></div>
...
<header id="header-p-beta2">
  <div class="header">
    <div class="wrap">
      ...
      #NTGUID__1 .drop-menu-group-active .drop-tips{  display: block;}</style><div id="NTGUID__1">
  <div class="link-menu-list">
    
          <a class="link-text-menu" href="http://www.liepin.com/" target="_blank">我是求职者</a>
          <a class="link-text-menu" href="http://www.liepin.com/user/lpt/" target="_blank">我是企业HR</a>
          <a class="link-text-menu" href="http://clt.liepin.com/" target="_blank">猎头公司</a>
      
    <span class="spliter"></span>
    <span class="drop-menu-group">
      <a class="link-drop-menu" title="手机猎聘网" target="_blank" href="http://sns.liepin.com/tongdao-app/index.html?mscid=c_a1_050#sfrom=click-pc_homepage-front_navigation-mobile_new"><i data-icon="icons16-mobile-gray" data-icon-hover="icons16-mobile-white" class="icons16 icons16-mobile-gray"></i>手机猎聘</a>
      		...
      		<div class="ui-tab-container">
        		<div class="ui-tab-toggle hide">
          		...
          		<input name="user_kind" value="2" type="hidden">
            		...
            		<div>
              			<input name="rand" data-name="rand" class="text input-xlarge validate-code" data-selector="validate-code" validate-title="验证码"  placeholder="请输入验证码" type="text">
            		...
            		<div class="actions">
              			<input class="btn btn-warning" name="tijiao" value="立即登录" type="submit">
            		</div>
          		</form>
        		</div>
          		...
          		<form lt-plugins-valid="0.6806296750298872" action="/user/ajaxregh" method="post" class="reg-form" autocomplete="off">
           		...
           		<input name="user_kind" value="2" type="hidden">
		            ...
		            <div class="control-group optional">
		              	<div>
		                	<label validate-title="《猎聘网用户服务协议》" validate-rules="[['required',{'min': 1},'请选择接受$才可注册']]" validate-group="checkbox"><input class="checkbox" name="chk_agreement" value="on" checked="checked" type="checkbox"> 接受用户协议</label>
		              	</div>
		            </div>
		            <div class="actions">
