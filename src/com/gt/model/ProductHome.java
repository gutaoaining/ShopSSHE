...
public class ProductHome {
	...
	public Product findById(java.lang.Integer id) {
		...
		try {
			Product instance = (Product) sessionFactory.getCurrentSession().get("com.gt.model.Product", id);
			if (instance == null) {
	...
	public List findByExample(Product instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.gt.model.Product")
