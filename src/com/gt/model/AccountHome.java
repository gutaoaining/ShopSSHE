...
public class AccountHome {
	...
	public Account findById(java.lang.Integer id) {
		...
		try {
			Account instance = (Account) sessionFactory.getCurrentSession().get("com.gt.model.Account", id);
			if (instance == null) {
	...
	public List findByExample(Account instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.gt.model.Account")
