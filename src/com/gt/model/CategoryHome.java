...
// Generated 2015-9-22 19:40:27 by Hibernate Tools 4.0.0
...
public class CategoryHome {
	...
	public Category findById(java.lang.Integer id) {
		...
		try {
			Category instance = (Category) sessionFactory.getCurrentSession().get("com.gt.model.Category", id);
			if (instance == null) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.gt.model.Category")
